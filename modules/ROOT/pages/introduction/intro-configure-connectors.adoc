...
*Reviewers: I know that users can put the placeholder file in other locations, but I want to describe one way only and I think this one is consistent with best practices.*
