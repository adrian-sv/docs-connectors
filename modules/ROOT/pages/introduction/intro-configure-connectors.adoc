...
To configure authorization credentials for a connector, it is recommended that you create a global element, which lets you reuse the configuration for other connector instances. For some connectors, configuring a global element is mandatory.
